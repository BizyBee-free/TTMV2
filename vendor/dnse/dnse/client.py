...
class DNSEClient:
    ...
    def get_deals(self, account_no, market_type, dry_run=False):
        """Legacy list of deals. Prefer :meth:`get_positions` (OpenAPI V2 naming)."""
        return self._request(
            "GET",
    ...
    def get_positions(self, account_no, market_type, dry_run=False):
        """List open positions (OpenAPI V2; replaces *deals* naming for the same role)."""
        return self._request(
            "GET",
    ...
    def get_security_definition(self, symbol, board_id=None, dry_run=False):
        # Path aligned with official dnse-tech/openapi-sdk: GET /price/{symbol}/secdef
        query = {}
        if board_id:
    ...
    def get_trades(self, symbol, board_id=None, from_date=None, to_date=None,
                   limit=None, order=None, next_page_token=None, dry_run=False):
        query = {}
    ...
    def get_instruments(self, symbol=None, market_id=None, security_group_id=None,
                        index_name=None, limit=None, page=None, dry_run=False):
        query = {}
